...
const getServerOptionsApi = window.isDev
    ? "/api/user/getServerOptions"
    : "/user/getServerOptions"; // 根据大区获取服务器下拉选项
const getNicknameByAreaApi = window.isDev
    ? "/api/user/getNicknameByArea"
    : "/user/getNicknameByArea"; // 根据大区和服务器获取角色昵称
